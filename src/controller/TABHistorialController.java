 ...
 * @author heber
 */
public class TABHistorialController extends MouseAdapter implements ActionListener, KeyListener, ItemListener {
    ...
    public TABHistorialController(List<JTable> tablesHistorial, List<JComboBox> combos, JLabel ventaDiaria, JTextField txtPrecio, List<JButton> buttonsHistorial) {
