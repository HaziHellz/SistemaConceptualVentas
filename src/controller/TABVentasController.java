 ...
 * @author heber
 */
public class TABVentasController extends MouseAdapter implements ActionListener, KeyListener {
    ...
    public TABVentasController(List<Object> componentes, GUI.Historial historial) {
